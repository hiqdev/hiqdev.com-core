...
сайта, как `yii2-app-basic,` только сделанная как плагин, что даёт определённые
преимущества:
...
Ещё один реальный рабочий проект, подходящий в качестве примера, полностью
доступный на GitHub'е и сделанный, используя этот подход -
