...
числе таким: в большом проекте используется много расширений &mdash; конфиг приложения
...
превращаем в расширение. И снова здравствуйте: у расширения есть свой конфиг &mdash;
...
Итак, решение такое: использовать систему плагинов &mdash; с самого начала создавать
...
радикальное решение &mdash; собирать конфиг за пределами приложения и ещё до его запуска
...
Всё! Не надо ничего копипастить в свой конфиг, не надо добавлять виджет в layout &mdash;
...
использования так сказать "малых архитектурных форм". Пора вернуться к главному &mdash;
...
реализации вашего проекта &mdash; то, чем этот вариант отличается от основного проекта.
...
Таким образом пакеты образуют иерархию композиции &mdash;
...
Конечно, можно и нужно класть в *"корень"* некоторый конфиг и даже код, специфичный
...
Одно из *"базовых приложений"*, которые мы развиваем &mdash; **HiSite**
[hiqdev/hisite](https://github.com/hiqdev/hisite) &mdash; это основа для типичного
...
нужен новый функционал &mdash; делаем новый плагин.
